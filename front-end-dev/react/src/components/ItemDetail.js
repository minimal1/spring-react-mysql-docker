    ...
    return (
      <section className='page-for-detail'>
        <div className='detail-for-paper'>
          ...
          <span>{this.state.year} / {this.state.category} / {this.state.professor}</span>
          <p className='detail-for-abstract'>
            {this.state.description_1}
          </p>
          <a href={`https://gradubucket.s3.ap-northeast-2.amazonaws.com/${this.state.keyName}`} target="_blank">
        ...
        <div className='detail-for-others'>
          ...
          <div className='detail-for-tasks'>
            ...
            <hr />
            <p>1. {this.state.description_1}</p><br/>
            <p>2. {this.state.description_2}</p><br/>
            <p>3. {this.state.description_3}</p><br/>
          </div>
        </div>
