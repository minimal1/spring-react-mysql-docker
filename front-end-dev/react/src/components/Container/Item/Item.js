...
class Item extends React.Component {
  ...
  render() {
    const {
      id, keyName, github, description_1
    } = this.props;
    ...
    return (
      <div className='paper-item'>
        ...
        <div className='paper-subinfo'>
          <a href={`https://gradubucket.s3.ap-northeast-2.amazonaws.com/${keyName}`} className='link-to-detail'>
          ...
          <a className='link-to-github' href={`${github}`}>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
